...
describe ImageUploader do
  ...
  describe ".allowed_file_types" do
    ...
    context ":as => :regexp_string" do
      it "should return '\\.(jpg|jpeg|gif|png)'" do
        subject.class.allowed_file_types(:as => :regexp_string).should == "\\.(jpg|jpeg|gif|png)"
      end
    end
      ...
      context ":as => :regexp" do
        ...
        context "a valid key" do
          ...
          context "with a valid extension" do
            before do
              subject.class.stub(:allowed_file_types).with(
                :as => :regexp_string
  ...
  describe "#has_key?" do
    ...
    context "the key has been set" do
      before { subject.key = sample_key(:mounted_as => :pic, :subject => "NightOut") }
